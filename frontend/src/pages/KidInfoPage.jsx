...
export default function KidInfoPage() {
  ...
  function handleSubmit() {
    ...
    if (!birthYear) { alert('태어난 년도를 입력해 주세요.'); return }
    if (!birthDate) { alert('태어난 월/일을 입력해 주세요.'); return }
      ...
      <div className="form-card">
        ...
        <div className="form-section">
          ...
          <div className="input-group">
            ...
            <input
              type="text" id="user-name" placeholder="이름을 입력하세요"
          ...
          <div className="input-group">
            ...
            <input
              type="number" id="birth-year" placeholder="예: 2000"
          ...
          <div className="input-group">
            ...
            <input
              type="text" id="birth-date" placeholder="예: 0520"
